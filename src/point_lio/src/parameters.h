...
extern std::string lid_topic, lid_B_topic, imu_topic;
...
extern double acc_cov_input,acc_z_cov_input, gyr_cov_input, vel_cov;
...
extern shared_ptr<Preprocess> p_pre_B;
extern shared_ptr<ImuProcess> p_imu;
extern bool is_first_frame;

extern std::vector<double> extrinT;
extern std::vector<double> extrinR;
extern std::vector<double> extrinT_B;
extern std::vector<double> extrinR_B;
