...
def generate_launch_description():
    ...
    base_frame = LaunchConfiguration("base_frame", default="lidar_odom")

    # ROS configuration
    pointcloud_topic = LaunchConfiguration("cloud_topic", default="/cloud_registered_body")
        ...
        parameters=[
            {
                ...
                "num_lpr": 10,  # Maximum number of points to be selected as lowest points representative.
                ...
                "th_dist": 0.02,  # threshold for thickness of ground.
                "th_seeds_v": 0.1,
                # threshold for lowest point representatives using in initial seeds selection of vertical structural points.
                "th_dist_v": 0.2,  # threshold for thickness of vertical structure.
                "max_range": 30.0,  # max_range of ground estimation area
                "min_range": 0.5,  # min_range of ground estimation area
                "uprightness_thr": 0.05,
