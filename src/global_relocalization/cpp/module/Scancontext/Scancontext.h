...
public: 
    ...
    SCManager(int _num_ring, int _num_sector, double _max_radius, double _lidar_height)
        : PC_NUM_RING(_num_ring), PC_NUM_SECTOR(_num_sector), 
          PC_MAX_RADIUS(_max_radius), LIDAR_HEIGHT(_lidar_height) {
